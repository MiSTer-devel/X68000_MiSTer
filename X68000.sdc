...
set_multicycle_path -from {emu:emu|X68K_top:X68K_top|TG68:MPU|*} -setup 2
set_multicycle_path -from {emu:emu|X68K_top:X68K_top|TG68:MPU|*} -hold 1
set_multicycle_path -to   {emu:emu|X68K_top:X68K_top|TG68:MPU|*} -setup 2
set_multicycle_path -to   {emu:emu|X68K_top:X68K_top|TG68:MPU|*} -hold 1
